...
export const About1 = () => {
  ...
  <div className="d-flex align-items-center flex-wrap mb-5">
    ...
    >
      <li>
        <i className="far fa-check" /> Education
      </li>
      <li>
        <i className="far fa-check" /> Healthcare
      </li>
    </ul>
    <ul
      className="checked-list wow fadeInUp"
    ...
    >
      <li>
        <i className="far fa-check" /> Climate Change
      </li>
      <li>
        <i className="far fa-check" /> Culture Preservation
      </li>
    </ul>
  </div>
  <Link
