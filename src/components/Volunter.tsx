...
export const Volunter = () => {
  const volunteers: {
  ...
  }[] = [
    {
      ...
      image: "/assets/img/volunter/6.png",
      social: [
    ...
    },
    {
      name: "Shah Sarbaz",
      role: "Co founder",
      image: "/assets/img/volunter/2.png",
      social: [
        { icon: "fab fa-facebook-f", link: "#" },
        { icon: "fab fa-twitter", link: "#" },
        { icon: "fab fa-vimeo-v", link: "#" },
    ...
    {
      name: "Niba Ali",
      role: "Co-lead, Life on Land",
      image: "/assets/img/volunter/Niba.jpg",
      social: [
        { icon: "fab fa-facebook-f", link: "#" },
        { icon: "fab fa-twitter", link: "#" },
        { icon: "fab fa-vimeo-v", link: "#" },
    ...
    {
      name: "Saqlain Ahmad",
      role: "Lead Climate Action Chitral",
      image: "/assets/img/volunter/3.png",
      social: [
        { icon: "fab fa-facebook-f", link: "#" },
        { icon: "fab fa-twitter", link: "#" },
        { icon: "fab fa-vimeo-v", link: "#" },
